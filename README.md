...
```bash
git https://github.com/sipalingkelas/razor-privatebug
cd razor-privatebug
npm install
```
...
git clone https://github.com/sipalingkelas/razor-privatebug
cd razor-privatebug
npm install
```
...
Editing Number Owner & session name in [`config.js`](https://github.com/sipalingkelas/razor-privatebug/blob/master/config.js)
...
* [`𝕾𝖆𝖙𝖆𝖓𝖎𝖈𝕽𝖆𝖟𝖔𝖗😈`](https://github.com/sipalingkelas)
